...
static void	print_float_bit(double double_num, char *str);
static t_bin	calc_xor(double a, double b);
static void	print_diff_bit(double a, double b, char *str);
static int		get_diff_bit(double a, double b);
...
int test(const char *str, int no, int *res_ret, int *res_end)
{
	...
	if (test_ret && test_endptr && !bit_diff)
