...
static t_bit96	add_bit96(t_bit96 a, t_bit96 b)
{
	uint64_t	c;
	t_bit96		add;
...
static t_bit96	sub_bit96(t_bit96 a, t_bit96 b)
{
	uint64_t	c;
	t_bit96		add;
...
static t_bit96	right_shift_bit96(t_bit96 a)
{
	t_bit96	shift;
...
static t_bit96	left_shift_bit96(t_bit96 a)
{
	t_bit96	shift;
...
static t_bit96 right_shift_n_times(t_bit96 b, int n)
{
	while (n > 0)
	{
...
static t_bit96 left_shift_n_times(t_bit96 b, int n)
{
	while (n > 0)
	{
...
static t_bit96	set_bit96(int64_t mantissa)
{
	t_bit96	f;
...
static void	print_bit32(int32_t b)
{
	int i;
...
static void	print_bit64(int64_t b)
{
	int64_t i;
...
static void	print_bit96(t_bit96 f)
{
	print_bit32(f.b2);
	printf(" ");
	print_bit32(f.b1);
...
// todo: ここむずい
static t_bit96	dev_by_ten(t_bit96 b)
{
	t_bit96 q, r, s;
...
static t_bit96 keep_upper4_is0(t_bit96 m, int *e)
{
...
static t_bit96	round_ties_even(t_bit96 s, int bit)
{
	uint32_t	even;
	uint32_t	mask;
	uint32_t	min_bit;
